...
SYSTEM_PROMPT = """
You are Share-k's explicit skill-gap guidance assistant.
...
def render_skill_gap_guidance_prompt(input_data: SkillGapGuidanceInput) -> str:
    ...
    return (
        ...
        "Use only the exact retrieved resource URLs above. If no retrieved "
        "resource is relevant, return an empty learningResources list."
    )
